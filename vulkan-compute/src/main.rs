...
void main() {
    ...
    let data_buffer = {
        ...
        let data_iter = (0 .. 65536u32).map(|n| cs::ty::InputData {
				dir: [0.0, 0.0, 0.0],
				origin: [n as f32, 0.0, 0.0],
    ...
    for n in 0 .. 65536u32 {
        assert_eq!(data_buffer_content[n as usize].origin[0], (n as f32) * 12.0);
    }
